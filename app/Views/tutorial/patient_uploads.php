<?php
$title = 'Ajuda do Paciente - Enviar fotos';
    ...
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">Enviar fotos</div>
            </div>
        </div>
        ...
        <div class="lc-flex lc-gap-sm lc-flex--wrap" style="align-items:center; justify-content:flex-end;">
            ...
            <a class="lc-btn lc-btn--secondary" href="/portal/uploads">Abrir Enviar fotos</a>
        </div>
    </div>

    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">Como enviar</div>
        <div class="lc-card__body" style="line-height:1.6;">
            - Selecione os arquivos solicitados pela clínica.
            <br />- Envie e aguarde o processamento/moderação (quando houver).
        </div>
    </div>
