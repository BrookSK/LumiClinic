<?php
$title = 'Ajuda do Paciente - Documentos';
    ...
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">Documentos</div>
            </div>
        </div>
        ...
        <div class="lc-flex lc-gap-sm lc-flex--wrap" style="align-items:center; justify-content:flex-end;">
            ...
            <a class="lc-btn lc-btn--secondary" href="/portal/documentos">Abrir Documentos</a>
        </div>
    </div>

    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">O que você encontra aqui</div>
        <div class="lc-card__body" style="line-height:1.6;">
            - Termos e documentos disponibilizados pela clínica
            <br />- Arquivos de assinatura (quando houver)
            <br />- Imagens médicas (quando houver)
        </div>
    </div>
