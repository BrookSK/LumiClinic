    ...
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">Busca</div>
            </div>
        </div>
        ...
        <div class="lc-flex lc-gap-sm lc-flex--wrap" style="align-items:center; justify-content:flex-end;">
            ...
            <a class="lc-btn lc-btn--secondary" href="/portal/busca">Abrir Busca</a>
        </div>
    </div>

    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">Como pesquisar</div>
        <div class="lc-card__body" style="line-height:1.6;">
            - Use a busca do topo para pesquisar rapidamente.
            <br />- Você também pode acessar a tela de busca pelo menu lateral.
        </div>
    </div>
