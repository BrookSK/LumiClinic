...
<div class="lc-app" style="padding: 16px; max-width: 980px; margin: 0 auto;">
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">Agenda (perfil: <?= htmlspecialchars($perfil, ENT_QUOTES, 'UTF-8') ?>)</div>
            </div>
        </div>
    ...
    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">O que você faz na Agenda</div>
        <div class="lc-card__body" style="line-height:1.6;">
            - Ver horários e atendimentos
            <br />- Criar um atendimento
            <br />- Cancelar / reagendar
            <br />- Operar o dia a dia (dependendo do perfil)
        </div>
    </div>

    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">Próximos passos (detalhamento)</div>
        <div class="lc-card__body" style="line-height:1.6;">
            Aqui vamos detalhar cada botão (criar, editar, cancelar, status, filtros, etc.) conforme você for validando.
        </div>
    </div>
