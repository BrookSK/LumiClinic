<?php
$title = 'Ajuda do Paciente - API Tokens';
    ...
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">API Tokens</div>
            </div>
        </div>
        ...
        <div class="lc-flex lc-gap-sm lc-flex--wrap" style="align-items:center; justify-content:flex-end;">
            ...
            <a class="lc-btn lc-btn--secondary" href="/portal/api-tokens">Abrir API Tokens</a>
            <a class="lc-btn lc-btn--secondary" href="/tutorial/api-tokens/paciente">Ver tutorial completo</a>
        </div>
    </div>

    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">Para que serve</div>
        <div class="lc-card__body" style="line-height:1.6;">
            API Tokens permitem que você use a API com segurança (sem senha). Você cria e revoga tokens nesta tela.
        </div>
    </div>
