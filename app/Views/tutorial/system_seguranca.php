...
<div class="lc-app" style="padding: 16px; max-width: 980px; margin: 0 auto;">
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">Segurança e permissões (perfil: <?= htmlspecialchars($perfil, ENT_QUOTES, 'UTF-8') ?>)</div>
            </div>
        </div>
    ...
    <div class="lc-card" style="margin-top:16px; padding:16px;">
        ...
        <div class="lc-card__body" style="line-height:1.6;">
            ...
            <br />- Permissões determinam quais telas/ações aparecem para cada usuário.
            <br />- Se um botão ou menu não aparece, normalmente é falta de permissão ou contexto (clínica).
        </div>
    </div>
