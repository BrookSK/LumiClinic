<?php
$title = 'Ajuda do Paciente - Portal';
...
<div class="lc-app" style="padding: 16px; max-width: 980px; margin: 0 auto;">
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">Visão geral do Portal</div>
            </div>
        </div>
    ...
    <div class="lc-card" style="margin-top:16px; padding:16px;">
        ...
        <div class="lc-card__body" style="line-height:1.6;">
            O Portal do Paciente é uma área onde você pode ver documentos, agenda, notificações e informações disponibilizadas pela clínica.
        </div>
    </div>

    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">Navegação</div>
        <div class="lc-card__body" style="line-height:1.6;">
            - Use o menu lateral para acessar as áreas.
            <br />- No topo, você pode pesquisar no portal.
            <br />- No canto superior direito, você pode sair.
        </div>
    </div>
