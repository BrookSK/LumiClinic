<?php
$title = 'Ajuda do Paciente - Agenda';
...
<div class="lc-app" style="padding: 16px; max-width: 980px; margin: 0 auto;">
    <div class="lc-page__header" style="gap:10px;">
        <div class="lc-flex lc-gap-sm" style="align-items:center;">
            ...
            <div>
                ...
                <div class="lc-page__subtitle" style="margin-top:2px;">Agenda</div>
            </div>
        </div>
    ...
    <div class="lc-card" style="margin-top:16px; padding:16px;">
        <div class="lc-card__title">O que dá para fazer</div>
        <div class="lc-card__body" style="line-height:1.6;">
            - Ver seus agendamentos
            <br />- Confirmar presença (quando disponível)
            <br />- Solicitar cancelamento
            <br />- Solicitar reagendamento
        </div>
    </div>
