...
<div class="lc-shell">
    <aside class="lc-sidebar">
        ...
        <nav class="lc-nav">
            <?php if ($isSuperAdmin): ?>
                <a class="lc-nav__item" href="/sys/clinics">Clínicas</a>
                <a class="lc-nav__item" href="/sys/billing">Assinaturas</a>
                <a class="lc-nav__item" href="/sys/settings/billing">Configurações</a>
                <a class="lc-nav__item" href="/sys/queue-jobs">Fila</a>
            <?php else: ?>
