...
<div class="lc-flex lc-flex--between lc-flex--center lc-flex--wrap" style="margin-bottom:14px; gap:10px;">
    <div class="lc-badge lc-badge--primary">Templates WhatsApp</div>
    <div class="lc-flex lc-gap-sm lc-flex--wrap">
        <?php if ($can('settings.update')): ?>
            <a class="lc-btn lc-btn--primary" href="/whatsapp-templates/create">Novo template</a>
        <?php endif; ?>
    </div>
</div>
        ...
        <table class="lc-table">
            ...
            <?php foreach ($templates as $t): ?>
                <tr>
                    ...
                    <td>
                        <?php if ($can('settings.update')): ?>
                            <a class="lc-btn lc-btn--secondary" href="/whatsapp-templates/edit?id=<?= (int)$t['id'] ?>">Editar</a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
