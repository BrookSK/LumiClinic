...
?>
<div class="lc-card">
    <div class="lc-card__title">Criar conta da clínica</div>

    <?php if ($error): ?>
        <div class="lc-alert lc-alert--danger"><?= htmlspecialchars((string)$error, ENT_QUOTES, 'UTF-8') ?></div>
    <?php endif; ?>

    <form method="post" class="lc-form" action="/criar-conta" autocomplete="off">
        ...
        <div class="lc-card" style="margin-top:14px;">
            <div class="lc-card__title">Dados do responsável</div>
            ...
            <input class="lc-input" type="password" name="owner_password" required minlength="8" />
        </div>

        <div class="lc-flex lc-gap-sm lc-flex--wrap" style="margin-top:14px;">
            <button class="lc-btn lc-btn--primary" type="submit">Criar conta</button>
            <a class="lc-btn lc-btn--secondary" href="/login">Já tenho conta</a>
        </div>
    </form>
</div>
<?php
