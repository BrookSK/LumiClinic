<?php
$title = 'Documentos legais (Portal)';
$rows = $rows ?? [];
ob_start();
?>
<div class="lc-card">
    <div class="lc-card__title">Documentos legais do Portal do Paciente</div>

    <div class="lc-flex lc-gap-sm" style="margin-top:12px;">
        <a class="lc-btn lc-btn--primary" href="/clinic/legal-documents/edit">Novo</a>
            ...
            <?php else: ?>
                <?php foreach ($rows as $r): ?>
                    <tr>
                        ...
                        <td>
                            <a class="lc-btn lc-btn--secondary" href="/clinic/legal-documents/edit?id=<?= (int)($r['id'] ?? 0) ?>">Editar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
