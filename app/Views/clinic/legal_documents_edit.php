...
?>
<div class="lc-card">
    <div class="lc-card__title">Documento legal (Portal do Paciente)</div>
    ...
    <form method="post" class="lc-form" action="/clinic/legal-documents/save">
        ...
        <div class="lc-flex lc-gap-sm lc-flex--wrap" style="margin-top:14px;">
            ...
            <a class="lc-btn lc-btn--secondary" href="/clinic/legal-documents">Voltar</a>
        </div>
    </form>
</div>
<?php
