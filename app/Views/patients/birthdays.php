...
<div class="lc-card" style="margin-bottom:14px;">
    ...
    <div class="lc-card__body">
        ...
        <div class="lc-muted" style="margin-top:6px; font-size:12px;">Envia apenas para pacientes com opt-in de WhatsApp ativo.</div>
...
(function(){
    ...
    if (btnAll) {
        btnAll.addEventListener('click', function(){
            ...
            // Coletar todos os pacientes com WA opt-in
            ...
            var sent = 0, failed = 0, total = btns.length;
