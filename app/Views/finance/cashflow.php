...
<div class="lc-card" style="margin-bottom: 16px;">
    ...
    <div class="lc-card__body">
        <form method="get" action="/finance/cashflow" class="lc-form" style="display:flex; gap: 12px; flex-wrap: wrap; align-items:end;">
            <div class="lc-field">
...
<div class="lc-card" style="margin-bottom: 16px;">
    ...
    <div class="lc-card__body">
        <form method="post" action="/finance/entries/create" class="lc-form" style="display:grid; grid-template-columns: 1fr 1fr 1fr 1fr 2fr; gap: 12px; align-items:end;">
