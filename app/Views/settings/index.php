...
<div class="cfg-section">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:12px;">
        ...
        <?php endif; ?>
        <?php if ($can('settings.update')): ?>
        <a href="/settings/tuquinha" style="padding:14px;border-radius:12px;border:1px solid rgba(17,24,39,.08);background:rgba(0,0,0,.01);text-decoration:none;color:inherit;display:flex;align-items:center;gap:10px;transition:all 160ms ease;">
            <span style="font-size:20px;">🔌</span>
            <div>
                <div style="font-weight:700;font-size:13px;color:rgba(31,41,55,.90);">Calendário Marketing</div>
                <div style="font-size:11px;color:rgba(31,41,55,.45);">Integração Tuquinha</div>
            </div>
        </a>
        <?php endif; ?>
    </div>
