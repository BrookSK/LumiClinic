...
$router->get('/settings/whatsapp/status-json', [SettingsController::class, 'whatsappStatusJson']);
$router->post('/settings/whatsapp/connect-json', [SettingsController::class, 'whatsappConnectJson']);
$router->post('/settings/whatsapp/disconnect', [SettingsController::class, 'whatsappDisconnect']);
...
$router->post('/finance/sales/delete', [SalesController::class, 'delete']);
...
$router->get('/patients/follow-up/export.pdf', [\App\Controllers\Patients\PatientReportsController::class, 'followUpPdf']);
